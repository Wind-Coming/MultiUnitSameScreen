...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        Mode m_Mode = Mode.BundleSetting;
        ...
        [SerializeField]
        internal BuildPipelineTab m_BuildTab;

        [SerializeField]
        internal AssetBundleInspectTab m_InspectTab;

        [SerializeField]
        internal AssetBundleSettingTab m_BundleSettingTab;
        ...
        [MenuItem("资源工具/资源配置打包窗口 _%_w", priority = 2050)]
        ...
        private void OnEnable()
        {
            ...
            if(m_BuildTab == null)
                m_BuildTab = new BuildPipelineTab();
            m_BuildTab.OnEnable(this);
            if (m_InspectTab == null)
                m_InspectTab = new AssetBundleInspectTab();
            m_InspectTab.OnEnable(subPos);
            if (m_BundleSettingTab == null)
                m_BundleSettingTab = new AssetBundleSettingTab();
            m_BundleSettingTab.OnEnable(this);
        ...
        private void OnGUI()
        {
            ...
            switch(m_Mode)
            {
                ...
                case Mode.Inspect:
                    ...
                    break;
                case Mode.BundleSetting:
                    m_BundleSettingTab.OnGUI(GetSubWindowArea());
                    break;
                case Mode.Browser:
                default:
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[4] { "Configure", "Build", "Inspect" , "BundleSetting"};
