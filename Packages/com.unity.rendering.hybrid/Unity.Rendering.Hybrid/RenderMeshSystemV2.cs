...
namespace Unity.Rendering
{
    ...
    public class RenderMeshSystemV2 : JobComponentSystem
    {
        ...
        CustomRenderGroup m_InstancedRenderMeshBatchGroup;
        ...
        protected override void OnCreate()
        {
            ...
            m_FrozenGroup = GetEntityQuery(
                ...
                ComponentType.Exclude<VertexCom>()
            );
            ...
            m_InstancedRenderMeshBatchGroup = new CustomRenderGroup(EntityManager, this, m_CullingJobDependencyGroup);
